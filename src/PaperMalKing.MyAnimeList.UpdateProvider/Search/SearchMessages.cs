...
internal static class SearchMessages
{
	...
	public const string QueryTooShort = "Search with at least 3 characters.";
	public const string QueryWithoutLettersOrDigits = "That query contains no letters or digits. Search for a title instead.";
	public const string Busy = "MyAnimeList is busy — try again in a moment.";
	public const string Failed = "Searching MyAnimeList failed. Try again in a moment.";
