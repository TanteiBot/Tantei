...
namespace PaperMalKing.Database.CompiledModels
{
    ...
    public partial class CustomUpdateColorEntityType
    {
        ...
        public static void CreateAnnotations(RuntimeEntityType runtimeEntityType)
        {
            ...
            var key = runtimeEntityType.FindKey(new[] { aniListUserId, id });
            ...
            runtimeEntityType.SetOriginalValuesFactory(
                ISnapshot (InternalEntityEntry source) =>
                {
                    ...
                    return ((ISnapshot)(new Snapshot<uint, int, int, byte>(((ValueComparer<uint>)(((IProperty)aniListUserId).GetValueComparer())).Snapshot(source.GetCurrentValue<uint>(aniListUserId)), ((ValueComparer<int>)(((IProperty)id).GetValueComparer())).Snapshot(source.GetCurrentValue<int>(id)), ((ValueComparer<int>)(((IProperty)colorValue).GetValueComparer())).Snapshot(source.GetCurrentValue<int>(colorValue)), ((ValueComparer<byte>)(((IProperty)updateType).GetValueComparer())).Snapshot(source.GetCurrentValue<byte>(updateType)))));
                });
            runtimeEntityType.SetStoreGeneratedValuesFactory(
                ISnapshot () => ((ISnapshot)(new Snapshot<uint, int>(((ValueComparer<uint>)(((IProperty)aniListUserId).GetValueComparer())).Snapshot(default(uint)), ((ValueComparer<int>)(((IProperty)id).GetValueComparer())).Snapshot(default(int))))));
            runtimeEntityType.SetTemporaryValuesFactory(
                ISnapshot (InternalEntityEntry source) => ((ISnapshot)(new Snapshot<uint, int>(default(uint), default(int)))));
            runtimeEntityType.SetShadowValuesFactory(
                ISnapshot (IDictionary<string, object> source) => ((ISnapshot)(new Snapshot<uint, int>((source.ContainsKey("AniListUserId") ? ((uint)(source["AniListUserId"])) : 0U), (source.ContainsKey("Id") ? ((int)(source["Id"])) : 0)))));
            ...
            runtimeEntityType.SetRelationshipSnapshotFactory(
                ...
                {
                    var entity = ((CustomUpdateColor)(source.Entity));
                    return ((ISnapshot)(new Snapshot<uint, int>(((ValueComparer<uint>)(((IProperty)aniListUserId).GetKeyValueComparer())).Snapshot(source.GetCurrentValue<uint>(aniListUserId)), ((ValueComparer<int>)(((IProperty)id).GetKeyValueComparer())).Snapshot(source.GetCurrentValue<int>(id)))));
                });
