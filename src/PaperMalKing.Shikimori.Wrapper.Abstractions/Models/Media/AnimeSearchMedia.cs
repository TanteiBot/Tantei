...
public sealed class AnimeSearchMedia : AnimeMedia, ISearchMedia
{
	...
	[JsonIgnore]
	public bool IsAdult => string.Equals(this.Rating, HentaiRating, StringComparison.OrdinalIgnoreCase);
}
