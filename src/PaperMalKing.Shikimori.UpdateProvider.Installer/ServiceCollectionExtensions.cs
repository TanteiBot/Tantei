...
public static class ServiceCollectionExtensions
{
	...
	public static void AddShikimori(this IServiceCollection serviceCollection, IConfiguration configuration)
	{
		...
		var rpmRl = RateLimiterFactory.Create<ShikiClient>(new(80, TimeSpan.FromMinutes(1, 25))); // 90rpm with .05 as inaccuracy
		var rpsRl = RateLimiterFactory.Create<ShikiClient>(new(4, TimeSpan.FromSeconds(1, 700))); // 5rps with .05 as inaccuracy
