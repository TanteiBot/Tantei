...
namespace PaperMalKing.AniList.Wrapper
{
    internal sealed class AniListClient
    {
        ...
        public async Task<CheckForUpdatesResponse> CheckForUpdatesAsync(ulong userId, byte page, ulong activitiesTimeStamp, ushort perChunk,
        ...
        public async Task<FavouritesResponse> FavouritesInfoAsync(byte page, ulong[] animeIds, ulong[] mangaIds, ulong[] charIds, ulong[] staffIds,
